...
async function run() {
    ...
    console.log('Previsões para as próximas 24 horas (data, hora e valor):');
    predictions.forEach(prediction => {
        console.log(`Data: ${prediction.predictedDate} | Hora: ${prediction.predictedHour} | Valor: R$ ${prediction.predictedPrice.toFixed(2)}`);
    });
}
